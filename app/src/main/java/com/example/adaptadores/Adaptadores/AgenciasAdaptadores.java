...
public class AgenciasAdaptadores extends BaseAdapter implements Filterable {
    ...
    AgenciasAdaptadores.CustomerFilter filtro; //filtra
    ArrayList<AgenciasItems.agenciasItems> filtroList; // (filtar datos)

    //constructor para llamar datos
    public AgenciasAdaptadores(Context context,ArrayList<AgenciasItems.agenciasItems> datos){
   ...
   /* //***********************
    //implementar métodos BaseAdapter - Filterable
    @Override
    public int getCount() {
        return 0;
    }
