...
public class AgenciasItems {
    ...
    static {
        addItem(new AgenciasItems.agenciasItems ("1","TaytaIntiTours", R.drawable.agenciauno,"aventura"));
        addItem(new AgenciasItems.agenciasItems("2","MachuppicchuAgency",R.drawable.agenciados,"aventura"));
        addItem(new AgenciasItems.agenciasItems("3","Amaru", R.drawable.agenciatres,"aventura"));
        addItem(new AgenciasItems.agenciasItems("4","Viajes", R.drawable.agenciacuatro,"aventura"));
        addItem(new AgenciasItems.agenciasItems("5","ViajesCusco", R.drawable.agenciacinco,"aventura"));
    }
